...
class MongoMigrator {
  ...
  async migrate() {
    ...
    await this.manager.client.withSession(async session => {
      await this.$prepareMigrationCollection(session);
  ...
  async $createMigrationCollectionIndexes(session) {
  ...
  async $createMigrationCollectionSchemaValidator(session) {
  ...
  async $prepareMigrationCollection(session) {
    await this.$createMigrationCollectionIndexes(session);
    await this.$createMigrationCollectionSchemaValidator(session);
  }
